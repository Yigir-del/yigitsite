...
export default function LeagueCharts({ matches, championStats }: LeagueChartsProps) {
  ...
  return (
    <section aria-label="Grafikler">
      <h3 className="league-section-title">Görselleştirmeler</h3>
      <div className="league-charts">
        <div className="league-chart-card card-surface">
          <h4>Win Rate Over Recent Games</h4>
